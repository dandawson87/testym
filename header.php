		...
		<div id="container">
			...
			<header class="header" role="banner">
				<div id="inner-header" class="wrap cf">
					...
					<div id="logo" class="h1 menulinkscontainer">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="nofollow" style="width:300px;margin:0 auto;display:block;">
							<img src="<?php echo esc_url( get_theme_mod( 'BIGPIX_logo' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" />
						</a>
						<div class='menulinks'>
							<p style='margin-left:25px;'><a href='/story'>OUR<br>YARN</a></p>
							<p><a href='/mates'>OUR<br>MATES</a></p>
							<p><a href='/find-us'>WATERING<BR>HOLES</a></p>
							<p><a href='/say-gday'>SAY<br>GDAY</a></p>
